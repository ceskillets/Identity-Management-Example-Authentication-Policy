...
parser.add_argument("--PASSPHRASE", help="Certificate Passphrase", type=str)
...
url = 'https://{}/api/?type=import&format=pkcs12&category=certificate&certificate-name={}&passphrase={}&key={}'.format(target_ip, cert_name, passphrase, api_key)
